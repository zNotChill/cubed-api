...
export declare function getPermissionValues(permissions: Array<keyof ServerManagerPermission>): Array<ServerManagerPermission[keyof ServerManagerPermission]>;
...
export declare enum ServerManagerPermissions {
    ADMIN = "administrator",
    EDIT_MANAGERS = "managers.edit",
    VIEW_FTP = "ftp.view",
    STOP_SERVER = "server.stop",
