...
export interface User {
  ...
  // thankfully my api already deals with this
  minigames: {
    warzone: any,
    tntwars: any,
    xrun: any,
...
export type ServerIcon = "DIAMOND" | "DIAMOND_SWORD" | "DIAMOND_CHESTPLATE" | "DIAMOND_PICKAXE" | "BOW" | "BED" |
...
export type ServerAttribute = "motd" | "version" | "icon" | "visibility" | "stop" |
                      "who-can-start";

export type ServerVersion = "spigot-1.8" | "paper-1.8" |
...
export function getPermissionValues(permissions: Array<keyof ServerManagerPermission>): Array<ServerManagerPermission[keyof ServerManagerPermission]> {
...
export enum ServerManagerPermissions {
  ADMIN = "administrator",
  EDIT_MANAGERS = "managers.edit",
  VIEW_FTP = "ftp.view",
  STOP_SERVER = "server.stop",
